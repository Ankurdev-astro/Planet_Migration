...
# x1, dens1, t1, last_checkpoint1 = file_opener('./rodeo.h5')
# print('Plotting ' + last_checkpoint1 + ' at t = {}'.format(t1))
# plt.plot(x1[:, 0], np.mean(dens1, axis=1), 'k-', label ='Disk without planet')
#
# x2, dens2, t2, last_checkpoint2 = file_opener('./rodeo_v50_o100.h5')
# print('Plotting ' + last_checkpoint2 + ' at t = {}'.format(t2))
# plt.plot(x2[:, 0], np.mean(dens2, axis=1), 'k--', label ='Disk with Jupiter-mass planet at $r_p = 1$')
